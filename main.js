...
function truncate(text, limit = 255) {
  ...
  return reduced || `${text.slice(0, limit - 3)}...`;
}
...
const str3 = "There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable."
console.log(truncate(str, 255));
console.log(truncate(str, 455));
console.log(truncate(str2, 100));
console.log(truncate(str2, 10))
console.log(truncate(str3, 80));
